...
<head>
	...
	<title> Jobify Jobs - Contact Us</title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="google.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Jamshedpur <br/> Jharkhand <br/></address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:priyanshutiwari@ obify.com">priyanshutiwari@Jobify.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:1800 565 8947">1800 565 8947</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p> Jobify Jobs is a job portal, online job management system Developed by Priyanshu tiwari & Anki Kumar for his project in february 2018.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="mailto:priyanshutiwari@ Jobify.com">priyanshutiwari@ Jobify.com</a></p>
								<p>Phone : <a href="tel:+233546607474">1800 565 8947</a></p>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Priyanshu tiwari & Anki Kumar</a></li>
								</ul>
